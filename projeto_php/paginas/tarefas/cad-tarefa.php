    ...
    <form class="needs-validation" action="index.php?menuop=inserir-tarefa" method="post" novalidate>
        ...
        <div class="row">
            <div class="mb-3 col-3">
                ...
                <input class="form-control" type="date" name="dataLembreTarefa" id="dataLembreTarefa">
            </div>
            <div class="mb-3 col-3">
                <label for="horaLembreTarefa" class="form-label">Hora de Lembrete</label>
                <input class="form-control" type="time" name="horaLembreTarefa" id="horaLembreTarefa">
            </div>
        </div>
        <div class="row">
            <div class="mb-3 col-3">
